...
|---|---|---|---|
| [fugu-ultra-vs-frontier/](fugu-ultra-vs-frontier/) | Sakana AI's fugu-ultra (a "multi-agent conductor") run through the same rigs as GLM-5.2, GPT-5.5, Opus 4.8, and Fable 5: reliability by effort (64/64), the conductor's hidden ~12x token tax, cost per run, and the planted cross-file-bug diligence test (in-context, n=10) — the conductor catches no more bugs than GPT-5.5 at ~4x the price | Jun 23–24, 2026 | [X: @PawelHuryn](https://x.com/i/status/2069706922027073839) |
