...
|---|---|---|---|
| [kimi-k3-day-one/](kimi-k3-day-one/) | Kimi K3 (2.8T params, largest open-weight model to date) on launch day, through the same 8-task agentic battery as Opus 4.8, GPT-5.5, GPT-5.6 Sol and Grok 4.5 — plus the capacity experiment: the same cell returned 0 tokens on launch night and 14/14 thirteen hours later, and how a throttle arriving as an HTTP 200 killed the longest tool chain every run | Jul 16–17, 2026 | [X: @PawelHuryn](https://x.com/i/status/2078039188834783367) |
