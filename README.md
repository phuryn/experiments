...
|---|---|---|---|
| [frontier-vs-open-audit/](frontier-vs-open-audit/) | An open-weights model (GLM-5.2) vs the closed frontier (Opus 4.8, GPT-5.5) on a real code audit: 21 hand-planted bugs, 10 read-only runs per model, blind-graded planted-bug recall | Jun 2026 | _(on publish)_ |
