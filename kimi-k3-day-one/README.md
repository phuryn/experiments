# Kimi K3: Day One (July 16–17, 2026)
...
Two experiments. The first asks whether it is any good. The second asks whether the first question was even measurable on day one.
...
- **One cell is DNF, not zero.** K3 never finished the stale-docs audit across five attempts. It is reported as missing, because scoring a throttle as a model failure would be wrong.
- **This set expires.** The throttle numbers describe July 16–17, 2026. Moonshot's capacity will move; that is the finding, not a flaw.
